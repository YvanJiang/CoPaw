...
class CoPawAgent(ReActAgent):
    ...
    def _create_toolkit(
        ...
        # Map of tool functions (including async_process tools)
        tool_functions = {
            "execute_shell_command": execute_shell_command,
            "launch_async_process": launch_async_process,
            "view_async_processes": view_async_processes,
            "stop_async_process": stop_async_process,
            "cleanup_async_process": cleanup_async_process,
            "read_file": read_file,
